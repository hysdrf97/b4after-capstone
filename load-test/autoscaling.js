...
export const options = {
    ...
    // Beban ditingkatkan untuk memicu auto-scaling
    stages: [
      { duration: '30s', target: 10  },  // warm up
      { duration: '1m',  target: 50  },  // sama dengan baseline
      { duration: '1m',  target: 100 },  // naik — picu scale out instance 2
      { duration: '1m',  target: 100 },  // tahan beban tinggi
...
export function handleSummary(data) {
  ...
  const report = {
    ...
    phase: "FASE 3 — Full System (Cache + Queue + Auto-Scaling)",
    ...
    global: {
      ...
      tps_avg:    (totalReqs / 210).toFixed(2),
  ...
  return {
    'results/autoscaling_report.json': json,
    stdout: '\n✅ Report saved to results/autoscaling_report.json\n',
  };
}
